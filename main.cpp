...
#define   OUT "%d,%04d"
  ...
  // Edit by JB
  res_file_name.append(argv[4]);
  res_file_name.erase(0, res_file_name.find_last_of("\\") + 1);
  res_file_name.erase(res_file_name.size() - 4, 4);
  res_file_name.append("_PSNR_result.txt");
  res_file = fopen(res_file_name.c_str(), "w");
  printf("%s\n", res_file_name.c_str());
